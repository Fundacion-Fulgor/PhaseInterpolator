...
N 1260 -290 1320 -290 {lab=VOUT}
N 430 -180 430 -100 {lab=VS[1:0]}
N 410 -180 410 -100 {lab=VST[7:0]}
N 900 -290 960 -290 {lab=#net3}
N 1080 -290 1140 -290 {lab=#net4}
N 1010 -250 1010 -160 {lab=VSS}
N 830 -160 1010 -160 {lab=VSS}
N 1010 -160 1190 -160 {lab=VSS}
N 1190 -250 1190 -160 {lab=VSS}
N 1190 -420 1190 -330 {lab=VDD}
N 1010 -420 1190 -420 {lab=VDD}
N 1010 -420 1010 -330 {lab=VDD}
N 830 -420 1010 -420 {lab=VDD}
...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 560 -150 0 0 {name=x2}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 740 -150 0 0 {name=x3[1:0]}
C {opin.sym} 1320 -290 0 0 {name=p5 lab=VOUT}
...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 920 -150 0 0 {name=x4[3:0]}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 1100 -150 0 0 {name=x5[7:0]}
