...
C {blocks/PI_clk/schematic/PI_clk.sym} 1350 -50 0 0 {name=x16}
...
C {blocks/flywheel_clk/schematic/flywheel_clk.sym} 450 -900 0 0 {name=x7
}
C {blocks/flywheel_clk/schematic/flywheel_clk.sym} 970 -900 0 0 {name=x12
}
