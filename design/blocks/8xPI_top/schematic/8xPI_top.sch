...
C {blocks/8xPI/schematic/8xPI.sym} 660 -140 0 0 {name=x1}
C {blocks/clock_gen/schematic/clock_gen.sym} 270 -300 0 0 {name=x2}
C {blocks/3to7_deco_v2/schematic/3to7_deco_v2.sym} 320 -520 0 0 {name=x3}
...
C {blocks/8xPI_logic/schematic/8xPI_logic.sym} 1010 -590 0 0 {name=x4}
