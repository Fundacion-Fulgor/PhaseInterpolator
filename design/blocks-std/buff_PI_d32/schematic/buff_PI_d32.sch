...
C {blocks-std/buff_PI_d16/schematic/buff_PI_d16.sym} 240 -150 0 0 {name=x5}
C {blocks-std/inv_PI_d16/schematic/inv_PI_d16.sym} 470 -150 0 0 {name=x15}
...
C {blocks-std/inv_PI_d32/schematic/inv_PI_d32.sym} 700 -150 0 0 {name=x20}
