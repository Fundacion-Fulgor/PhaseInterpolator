...
C {blocks-std/inv/schematic/inv.sym} 70 -10 0 0 {name=x7}
C {blocks-std/inv_d2/schematic/inv_d2.sym} 320 -150 0 0 {name=x8}
C {blocks-std/inv_d4/schematic/inv_d4.sym} 480 -150 0 0 {name=x9}
C {blocks-std/inv_d8/schematic/inv_d8.sym} 640 -150 0 0 {name=x10}
