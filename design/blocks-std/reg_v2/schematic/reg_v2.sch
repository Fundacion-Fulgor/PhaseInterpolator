...
C {blocks-std/tg_custom/schematic/tg_custom.sym} 340 -380 2 1 {name=x3}
C {blocks-std/inv/schematic/inv.sym} 120 -520 0 0 {name=x9}
C {blocks-std/inv/schematic/inv.sym} 60 -240 0 0 {name=x4}
C {blocks-std/inv/schematic/inv.sym} 60 40 0 0 {name=x8}
C {blocks-std/inv/schematic/inv.sym} 880 -220 0 0 {name=x11}
C {blocks-std/inv/schematic/inv.sym} 880 40 0 0 {name=x10}
C {blocks-std/tg_custom/schematic/tg_custom.sym} 340 -100 2 1 {name=x2}
...
C {blocks-std/tg_custom/schematic/tg_custom.sym} 1160 -360 2 1 {name=x6}
...
C {blocks-std/tg_custom/schematic/tg_custom.sym} 1160 -100 2 1 {name=x7}
...
C {blocks-std/inv/schematic/inv.sym} 540 -240 0 0 {name=x5}
...
C {blocks-std/inv/schematic/inv.sym} 1290 -220 0 0 {name=x1}
