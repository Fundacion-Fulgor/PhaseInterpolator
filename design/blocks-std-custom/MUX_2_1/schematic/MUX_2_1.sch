...
C {blocks-std-custom/tieh_custom/schematic/tieh_custom.sym} 200 -750 0 0 {name=x12}
C {blocks-std-custom/tiel_custom/schematic/tiel_custom.sym} 180 -120 0 0 {name=x7}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 530 -750 0 0 {name=x14}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 530 -550 0 0 {name=x15[1:0]}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 530 -320 0 0 {name=x16}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 530 -120 0 0 {name=x17[1:0]}
C {blocks-std-custom/inv/schematic/inv.sym} 240 -290 0 0 {name=x10}
C {blocks-std-custom/inv_PI/schematic/inv_PI.sym} 140 -410 0 0 {name=x4}
C {blocks-std-custom/inv_PI/schematic/inv_PI.sym} 140 -180 0 0 {name=x9}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 820 -550 0 0 {name=x11
}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 820 -320 0 0 {name=x13
}
