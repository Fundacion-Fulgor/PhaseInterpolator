...
C {blocks-std-custom/inv_PI_d2/schematic/inv_PI_d2.sym} 160 -150 0 0 {name=x7}
C {blocks-std-custom/inv_PI_d4/schematic/inv_PI_d4.sym} 320 -150 0 0 {name=x8}
C {blocks-std-custom/inv_PI_d8/schematic/inv_PI_d8.sym} 480 -150 0 0 {name=x9}
C {blocks-std-custom/inv_PI_d16/schematic/inv_PI_d16.sym} 640 -150 0 0 {name=x10}
