...
C {blocks-std-custom/inv/schematic/inv.sym} 50 -160 0 0 {name=x1}
C {blocks-std-custom/tg_custom/schematic/tg_custom.sym} 420 -130 0 0 {name=x3}
...
C {blocks-std-custom/inv_xor/schematic/inv_xor.sym} 50 -30 0 0 {name=x2}
