...
C {/foss/designs/PhaseInterpolator/2to4/2to4.sym} -1102750 -1113460 0 0 {name=x1}
...
meas tran PW90 TRIG v(v90) VAL=0.6 RISE=3 TARG v(v90) VAL=0.6 FALL=3
...
C {devices/vsource.sym} -1103860 -1113550 0 0 {name=VIN1 value="PULSE(0 1.2 0 10p 10p 240p 500p)" savecurrent=false
}
C {devices/gnd.sym} -1103860 -1113500 0 0 {name=l5 lab=GND}
C {devices/vsource.sym} -1103860 -1113390 0 0 {name=VIN2 value="PULSE(0 1.2 250p 10p 10p 240p 500p)" savecurrent=false
}
