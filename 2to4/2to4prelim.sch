...
L 4 1400 -640 2520 -640 {}
L 4 2520 -1400 2520 -640 {}
L 4 1400 -1400 2520 -1400 {}
T {2to4
...
N 1890 -1110 1930 -1110 {lab=#net1}
...
N 2070 -1300 2250 -1300 {lab=#net3}
N 1820 -710 1820 -680 {lab=VSS}
N 1820 -820 1820 -790 {lab=VDD}
N 1890 -750 1930 -750 {lab=#net4}
...
N 1890 -920 1930 -920 {lab=#net5}
N 2050 -920 2090 -920 {lab=VIB}
N 1570 -920 1770 -920 {lab=VINI}
N 1780 -680 1820 -680 {lab=VSS}
N 2300 -1070 2300 -1040 {lab=VSS}
N 2370 -1110 2410 -1110 {lab=VQ}
N 1980 -1190 1980 -1150 {lab=VDD}
N 1820 -1190 1820 -1150 {lab=VDD}
N 2140 -1190 2140 -1150 {lab=VDD}
N 1980 -1190 2140 -1190 {lab=VDD}
N 2070 -1110 2090 -1110 {lab=#net3}
N 2050 -1110 2070 -1110 {lab=#net3}
N 2210 -1110 2250 -1110 {lab=#net6}
N 2300 -1190 2300 -1150 {lab=VDD}
N 2140 -1190 2300 -1190 {lab=VDD}
N 2370 -1300 2410 -1300 {lab=VQB}
N 1570 -1170 1570 -1110 {lab=VINI}
N 2070 -1300 2070 -1110 {lab=#net3}
N 1660 -1190 1820 -1190 {lab=VDD}
N 1660 -1190 1660 -1160 {lab=VDD}
N 2300 -1260 2300 -1230 {lab=VSS}
N 2300 -1380 2300 -1340 {lab=VDD}
N 1820 -1190 1980 -1190 {lab=VDD}
N 1860 -1380 2300 -1380 {lab=VDD}
N 1820 -1000 1980 -1000 {lab=VDD}
N 1820 -820 1980 -820 {lab=VDD}
N 2140 -1040 2300 -1040 {lab=VSS}
N 2220 -1230 2300 -1230 {lab=VSS}
...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 2050 -970 0 0 {name=x4}
...
C {opin.sym} 2410 -1110 0 0 {name=p4 lab=VQ}
C {opin.sym} 2410 -1300 0 0 {name=p2 lab=VQB}
...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/buff_d16.sym} 2300 -1110 0 0 {name=x9}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/buff_d16.sym} 2300 -1300 0 0 {name=x10}
C {devices/lab_pin.sym} 2300 -1190 2 0 {name=p10 sig_type=std_logic lab=VDD}
...
C {devices/lab_pin.sym} 2220 -1230 0 0 {name=p13 sig_type=std_logic lab=VSS}
