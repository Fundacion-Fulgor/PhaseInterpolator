...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/nor_x3_custom.sym} 50 -60 0 0 {name=x1}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 260 0 0 0 {name=x2}
