...
N 760 -640 760 -590 {lab=VSS}
N 700 -510 700 -460 {lab=VDD}
N 700 -640 700 -590 {lab=VSS}
N 650 -550 680 -550 {lab=#net5}
N 650 -750 650 -550 {lab=#net5}
N 840 -320 910 -320 {lab=VOUT}
N 700 -280 700 -230 {lab=VDD}
N 760 -410 760 -360 {lab=VSS}
N 760 -280 760 -230 {lab=VDD}
N 700 -410 700 -360 {lab=VSS}
...
C {lab_wire.sym} 760 -460 0 0 {name=p25 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 760 -640 2 0 {name=p26 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 700 -460 0 0 {name=p27 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 700 -640 2 0 {name=p28 sig_type=std_logic lab=VSS}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 760 -320 0 0 {name=x6
}
C {lab_wire.sym} 700 -230 0 1 {name=p29 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 760 -410 0 0 {name=p30 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 760 -230 0 1 {name=p31 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 700 -410 0 0 {name=p32 sig_type=std_logic lab=VSS}
