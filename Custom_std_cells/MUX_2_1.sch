...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tieh_custom.sym} 200 -750 0 0 {name=x12}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tiel_custom.sym} 180 -120 0 0 {name=x7}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 530 -750 0 0 {name=x14}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 530 -550 0 0 {name=x15[1:0]}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 530 -320 0 0 {name=x16}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 530 -120 0 0 {name=x17[1:0]}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 240 -290 0 0 {name=x10}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_PI.sym} 140 -410 0 0 {name=x4}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_PI.sym} 140 -180 0 0 {name=x9}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 820 -550 0 0 {name=x11
}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/tg_custom.sym} 820 -320 0 0 {name=x13
}
