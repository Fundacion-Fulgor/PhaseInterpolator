...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv.sym} 70 -10 0 0 {name=x7}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_d2.sym} 320 -150 0 0 {name=x8}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_d4.sym} 480 -150 0 0 {name=x9}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_d8.sym} 640 -150 0 0 {name=x10}
