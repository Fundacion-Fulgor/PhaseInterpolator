...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_d2.sym} 400 -490 0 0 {name=x13
}
C {lab_pin.sym} 400 -390 3 0 {name=p35 sig_type=std_logic lab=VSS}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_d2.sym} 400 -180 0 1 {name=x14
}
