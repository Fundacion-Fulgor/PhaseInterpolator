...
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_PI_d2.sym} 220 -290 0 0 {name=x5}
C {devices/lab_pin.sym} 220 -220 2 0 {name=p23 sig_type=std_logic lab=VSS}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_PI_d2.sym} 220 -90 0 0 {name=x6}
C {devices/lab_pin.sym} 220 -160 2 0 {name=p24 sig_type=std_logic lab=VDD}
C {/foss/designs/PhaseInterpolator/Custom_std_cells/inv_PI_d2.sym} 560 -190 0 0 {name=x7}
